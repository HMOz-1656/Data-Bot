...
function Shoes() {
    ...
    useEffect(() =>{
        ...
        .then((data) => {
         console.log(data);
         setloading(false)
         SetProductData(data.filter(product =>product.gender==loginuser.gender && product.category=="shoes"));
  ...
  return (
    <>
    <Header1 />
    <h3 style={{textAlign:"center",fontWeight:"bold",color:"#0A5995",marginTop:"30px"}}>SHOES</h3>
 ...
 {
     ProductData.slice(1,200).filter((i)=>i.price>0).map((i) => (
         <>
