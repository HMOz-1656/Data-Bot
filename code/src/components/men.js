...
var datac=dataaa.filter((v, i, a) => a.indexOf(v) === i)
    ...
    var dataapi=ProductData.filter(product =>{
      return(
        product.gender=="men"
...
/>
 ...
 <Container >
   ...
   <Grid container spacing={2} style={{marginTop:"10px"}}>
    ...
    <h3 style={{textAlign:"center",fontWeight:"bold",color:"#0A5995",marginTop:"30px"}}>MEN</h3>
    <div> 
...
dataapi.length==0?<h3>No Products</h3>:
    <Grid container spacing={2}>


   {
     dataapi.filter((i)=>i.price>0).map((i) => 
