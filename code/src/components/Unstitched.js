...
function Unstitched() {
    ...
    useEffect(() =>{
        ...
        .then((data) => {
         console.log(data);
         setloading(false)
         SetProductData(data.filter(product =>product.gender==loginuser.gender && product.category=="unstitched"));
  ...
  return (
    <>
    <Header1 />
    <h3 style={{textAlign:"center",fontWeight:"bold",color:"#0A5995",marginTop:"30px"}}>UNSTITCHED</h3>
